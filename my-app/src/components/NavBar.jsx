        ...
        <div className={"flex items-center justify-between  py-5 font-medium"}>
            ...
            <div className="flex items-center gap-6">
                <img
                    ...
                    className='w-5 cursor-pointer' src={assets.search_icon} alt={'search icon'}/>
                ...
                <div className="group relative">
                    ...
                    <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                        <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
                            <p className="cursor-pointer hover:text-black">Профиль</p>
                            <p className="cursor-pointer hover:text-black">Заказы</p>
                            <p className="cursor-pointer hover:text-black">Выйти</p>
                        </div>
                    </div>
                </div>
                ...
                <img
                    ...
                    src={assets.menu_icon} alt="menu" className="w-5 cursor-pointer sm:hidden"/>
            </div>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible === true ? 'w-full' : 'w-0'}`}>
                <div className="flex flex-col text-gray-600">
                    ...
                    <NavLink onClick={() => setVisible(false)} className="py-2 pl-6 border" to={"/collection"}>КАТЕГОРИИ</NavLink>
                    <NavLink onClick={() => setVisible(false)} className="py-2 pl-6 border" to={"/about"}>О НАС</NavLink>
                    <NavLink onClick={() => setVisible(false)} className="py-2 pl-6 border" to={"/contact"}>КОНТАКТЫ</NavLink>
                </div>
            </div>
